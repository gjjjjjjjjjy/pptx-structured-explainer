...
- Match command syntax to the target operating system. On Windows, use native Windows Python, PowerShell paths, and PowerShell backtick continuations or single-line commands. Use the Windows PowerPoint COM backend for interactive desktop rendering and LibreOffice for unattended service execution.
